...
Public Class BookingReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cinema_Ticketing_System.BookingReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_BookingID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBookingReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BookingReceipt = New BookingReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
