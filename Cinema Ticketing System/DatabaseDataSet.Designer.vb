...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class BookingDataTable
        ...
        Private columnAmountOfPeople As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public ReadOnly Property AmountOfPeopleColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnAmountOfPeople
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddBookingRow(ByVal CustomerName As String, ByVal CustomerIC As String, ByVal MovieScheduleID As Integer, ByVal AmountOfPeople As Integer, ByVal BookingDate As Date) As BookingRow
            Dim rowBookingRow As BookingRow = CType(Me.NewRow,BookingRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CustomerName, CustomerIC, MovieScheduleID, AmountOfPeople, BookingDate}
        ...
        Friend Sub InitVars()
            ...
            Me.columnAmountOfPeople = MyBase.Columns("AmountOfPeople")
        ...
        Private Sub InitClass()
            ...
            Me.columnAmountOfPeople = New Global.System.Data.DataColumn("AmountOfPeople", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnAmountOfPeople)
            ...
            Me.columnCustomerIC.AllowDBNull = false
            Me.columnCustomerIC.MaxLength = 20
            Me.columnMovieScheduleID.AllowDBNull = false
            Me.columnAmountOfPeople.AllowDBNull = false
    ...
    Partial Public Class BookingRow
        ...
        Public Property MovieScheduleID() As Integer
            Get
                Return CType(Me(Me.tableBooking.MovieScheduleIDColumn),Integer)
            End Get
            Set
                Me(Me.tableBooking.MovieScheduleIDColumn) = value
            End Set
        End Property
        ...
        Public Property AmountOfPeople() As Integer
            Get
                Return CType(Me(Me.tableBooking.AmountOfPeopleColumn),Integer)
            End Get
            Set
                Me(Me.tableBooking.AmountOfPeopleColumn) = value
            End Set
        End Property
...
Namespace DatabaseDataSetTableAdapters
    ...
    Partial Public Class BookingTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("AmountOfPeople", "AmountOfPeople")
            tableMapping.ColumnMappings.Add("BookingDate", "BookingDate")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Booking] WHERE (([BookingID] = @Original_BookingID) AND ([Cust"& _ 
                "omerName] = @Original_CustomerName) AND ([CustomerIC] = @Original_CustomerIC) AN"& _ 
                "D ([MovieScheduleID] = @Original_MovieScheduleID) AND ([AmountOfPeople] = @Origi"& _ 
                "nal_AmountOfPeople) AND ([BookingDate] = @Original_BookingDate))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_AmountOfPeople", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "AmountOfPeople", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Booking] ([CustomerName], [CustomerIC], [MovieScheduleID], [Am"& _ 
                "ountOfPeople], [BookingDate]) VALUES (@CustomerName, @CustomerIC, @MovieSchedule"& _ 
                "ID, @AmountOfPeople, @BookingDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT BookingID, CustomerName, CustomerIC,"& _ 
                " MovieScheduleID, AmountOfPeople, BookingDate FROM Booking WHERE (BookingID = SC"& _ 
                "OPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@AmountOfPeople", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "AmountOfPeople", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Booking] SET [CustomerName] = @CustomerName, [CustomerIC] = @Custom"& _ 
                "erIC, [MovieScheduleID] = @MovieScheduleID, [AmountOfPeople] = @AmountOfPeople, "& _ 
                "[BookingDate] = @BookingDate WHERE (([BookingID] = @Original_BookingID) AND ([Cu"& _ 
                "stomerName] = @Original_CustomerName) AND ([CustomerIC] = @Original_CustomerIC) "& _ 
                "AND ([MovieScheduleID] = @Original_MovieScheduleID) AND ([AmountOfPeople] = @Ori"& _ 
                "ginal_AmountOfPeople) AND ([BookingDate] = @Original_BookingDate));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Book"& _ 
                "ingID, CustomerName, CustomerIC, MovieScheduleID, AmountOfPeople, BookingDate FR"& _ 
                "OM Booking WHERE (BookingID = @BookingID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@AmountOfPeople", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "AmountOfPeople", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_AmountOfPeople", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "AmountOfPeople", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT BookingID, CustomerName, CustomerIC, MovieScheduleID, AmountOfPeople, Book"& _ 
                "ingDate FROM dbo.Booking"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DatabaseDataSet.BookingDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DatabaseDataSet.BookingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DatabaseDataSet.BookingDataTable = New DatabaseDataSet.BookingDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DatabaseDataSet.BookingDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_BookingID As Integer, ByVal Original_CustomerName As String, ByVal Original_CustomerIC As String, ByVal Original_MovieScheduleID As Integer, ByVal Original_AmountOfPeople As Integer, ByVal Original_BookingDate As Date) As Integer
            ...
            If (Original_CustomerIC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CustomerIC")
            Else
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_CustomerIC,String)
            End If
            Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_MovieScheduleID,Integer)
            Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_AmountOfPeople,Integer)
            Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_BookingDate,Date)
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerName As String, ByVal CustomerIC As String, ByVal MovieScheduleID As Integer, ByVal AmountOfPeople As Integer, ByVal BookingDate As Date) As Integer
            ...
            If (CustomerIC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CustomerIC")
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(CustomerIC,String)
            End If
            Me.Adapter.InsertCommand.Parameters(2).Value = CType(MovieScheduleID,Integer)
            Me.Adapter.InsertCommand.Parameters(3).Value = CType(AmountOfPeople,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal CustomerName As String, ByVal CustomerIC As String, ByVal MovieScheduleID As Integer, ByVal AmountOfPeople As Integer, ByVal BookingDate As Date, ByVal Original_BookingID As Integer, ByVal Original_CustomerName As String, ByVal Original_CustomerIC As String, ByVal Original_MovieScheduleID As Integer, ByVal Original_AmountOfPeople As Integer, ByVal Original_BookingDate As Date, ByVal BookingID As Integer) As Integer
            If (CustomerName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CustomerName")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(MovieScheduleID,Integer)
            Me.Adapter.UpdateCommand.Parameters(3).Value = CType(AmountOfPeople,Integer)
            ...
            If (Original_CustomerIC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CustomerIC")
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_CustomerIC,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_MovieScheduleID,Integer)
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_AmountOfPeople,Integer)
            Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_BookingDate,Date)
            Me.Adapter.UpdateCommand.Parameters(11).Value = CType(BookingID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerName As String, ByVal CustomerIC As String, ByVal MovieScheduleID As Integer, ByVal AmountOfPeople As Integer, ByVal BookingDate As Date, ByVal Original_BookingID As Integer, ByVal Original_CustomerName As String, ByVal Original_CustomerIC As String, ByVal Original_MovieScheduleID As Integer, ByVal Original_AmountOfPeople As Integer, ByVal Original_BookingDate As Date) As Integer
            Return Me.Update(CustomerName, CustomerIC, MovieScheduleID, AmountOfPeople, BookingDate, Original_BookingID, Original_CustomerName, Original_CustomerIC, Original_MovieScheduleID, Original_AmountOfPeople, Original_BookingDate, Original_BookingID)
        End Function
    End Class
