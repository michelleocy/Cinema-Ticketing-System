...
Public Class MovieTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cinema_Ticketing_System.MovieTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Purchase_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMovieTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MovieTicket = New MovieTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
